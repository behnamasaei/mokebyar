...
public class MokebyarCoreDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MokebyarCoreGlobalFeatureConfigurator.Configure();
        MokebyarCoreModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MokebyarCoreDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MokebyarCoreResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MokebyarCore");

            options.DefaultResourceType = typeof(MokebyarCoreResource);
        ...
        {
            options.MapCodeNamespace("MokebyarCore", typeof(MokebyarCoreResource));
        });
    }
}
