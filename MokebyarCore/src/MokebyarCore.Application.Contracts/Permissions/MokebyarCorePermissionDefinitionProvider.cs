...
namespace MokebyarCore.Permissions;

public class MokebyarCorePermissionDefinitionProvider : PermissionDefinitionProvider
{
    ...
    {
        return LocalizableString.Create<MokebyarCoreResource>(name);
    }
}
