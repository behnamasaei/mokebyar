...
{
    [DbContext(typeof(MokebyarCoreDbContext))]
    [Migration("20260115064255_add multi-tentant to traffic")]
    partial class addmultitentanttotraffic
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MokebyarCore.MokebModels.Mokeb", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<Guid>("MokebManagerId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MokebManagerId");

                    b.ToTable("AppMokeb", (string)null);
                });

            modelBuilder.Entity("MokebyarCore.MokebModels.MokebManager", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppMokebManager", (string)null);
                });

            modelBuilder.Entity("MokebyarCore.MokebModels.Pilgrim", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MokebyarCore.MokebModels.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppReservation", (string)null);
                });

            modelBuilder.Entity("MokebyarCore.MokebModels.Traffic", b =>
                {
                    b.Property<Guid>("MokebId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("MokebId", "ReservationId", "PilgrimId", "Time");

                    b.HasIndex("PilgrimId");

                    b.HasIndex("ReservationId");

                    b.ToTable("AppTraffic", (string)null);
                });
            ...
            modelBuilder.Entity("MokebyarCore.MokebModels.Mokeb", b =>
                {
                    b.HasOne("MokebyarCore.MokebModels.MokebManager", "MokebManager")
                        .WithMany("Mokebs")
                        .HasForeignKey("MokebManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MokebManager");
                });

            modelBuilder.Entity("MokebyarCore.MokebModels.Reservation", b =>
                {
                    b.HasOne("MokebyarCore.MokebModels.Mokeb", "Mokeb")
                        .WithMany("Reservations")
                        .HasForeignKey("MokebId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MokebyarCore.MokebModels.Pilgrim", "Pilgrim")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("MokebyarCore.MokebModels.Traffic", b =>
                {
                    ...
                    b.HasOne("MokebyarCore.MokebModels.Reservation", "Reservation")
                        .WithMany("Traffics")
