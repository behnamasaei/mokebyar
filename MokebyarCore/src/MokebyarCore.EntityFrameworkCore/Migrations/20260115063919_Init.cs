...
namespace MokebyarCore.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AppMokebManager",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Code = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ManagerName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMokebManager", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassportNumber = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Capacity = table.Column<int>(type: "int", maxLength: 10000, nullable: false),
                    Gender = table.Column<int>(type: "int", nullable: false),
                    MokebManagerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppMokeb_AppMokebManager_MokebManagerId",
                        column: x => x.MokebManagerId,
                        principalTable: "AppMokebManager",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionNumber = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppReservation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppReservation_AppMokeb_MokebId",
                        column: x => x.MokebId,
                        principalTable: "AppMokeb",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppReservation_AppPilgrim_PilgrimId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTraffic", x => new { x.MokebId, x.ReservationId, x.PilgrimId, x.Time });
                    table.ForeignKey(
                        name: "FK_AppTraffic_AppMokeb_MokebId",
                        column: x => x.MokebId,
                        principalTable: "AppMokeb",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppTraffic_AppPilgrim_PilgrimId",
                        column: x => x.PilgrimId,
                        principalTable: "AppPilgrim",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppTraffic_AppReservation_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "AppReservation",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMokeb_MokebManagerId",
                table: "AppMokeb",
                column: "MokebManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPilgrim_PassportNumber",
                table: "AppPilgrim",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppReservation_MokebId",
                table: "AppReservation",
                column: "MokebId");

            migrationBuilder.CreateIndex(
                name: "IX_AppReservation_PilgrimId",
                table: "AppReservation",
                column: "PilgrimId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTraffic_PilgrimId",
                table: "AppTraffic",
                column: "PilgrimId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTraffic_ReservationId",
                table: "AppTraffic",
